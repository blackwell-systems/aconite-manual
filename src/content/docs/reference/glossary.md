...
after note-off. See [The envelope pool](/envelopes/pool/).
...
[Voice & play](/performance/voice-and-play/).
...
step sequencer. See [Step sequencer](/performance/step-sequencer/).
...
and [The envelope pool](/envelopes/pool/).
...
Multimode filter models. See [The two filters](/filters/the-two-filters/).
...
[FX rack](/effects/using-the-rack/).
...
part of the FX rack. See [Effect by effect](/effects/effect-by-effect/).
...
a Juno-style DCO. See [Oscillators](/sources/oscillators/).
...
See [Oscillators](/sources/oscillators/).
...
model's own saturation character. See [The two filters](/filters/the-two-filters/).
...
[The envelope pool](/envelopes/pool/).
...
[The two filters](/filters/the-two-filters/) and
...
feedback). See [Oscillators](/sources/oscillators/).
...
that moves many parameters at once. See [Modulation matrix](/modulation/matrix/).
...
[Keyboard & mouse shortcuts](/reference/shortcuts/).
...
added. See [Effect by effect](/effects/effect-by-effect/).
...
ring with inharmonic character. See [Oscillators](/sources/oscillators/).

**Modulation**: using one signal to control another parameter over time. In Aconite all
modulation routes run through the [Modulation matrix](/modulation/matrix/) or
...
shape A to shape B. See [The two filters](/filters/the-two-filters/) and
...
configurable. See [Voice & play](/performance/voice-and-play/).
...
Available as a mod-matrix source. See [Modulation matrix](/modulation/matrix/).
...
303-style glide into the next note. See [Voice & play](/performance/voice-and-play/)
and [Step sequencer](/performance/step-sequencer/).
...
a mod-matrix destination. See [Oscillators](/sources/oscillators/).
...
approach or enter self-oscillation. See [The two filters](/filters/the-two-filters/).
...
MIDI channel. See [Voice & play](/performance/voice-and-play/).
...
mode and Glide time to be set. See [Step sequencer](/performance/step-sequencer/).
...
more nasal. See [Oscillators](/sources/oscillators/).
...
controls. See [Voice & play](/performance/voice-and-play/).
...
shape is fully drawable. See [Effect by effect](/effects/effect-by-effect/).
